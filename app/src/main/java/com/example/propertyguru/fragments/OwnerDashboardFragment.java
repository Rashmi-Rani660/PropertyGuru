...
import com.example.propertyguru.CustomerServiceActivity;
import com.example.propertyguru.EditListingActivity;
import com.example.propertyguru.HomeActivity;
import com.example.propertyguru.PostPropertyActivity;
import com.example.propertyguru.ProfileActivity;
import com.example.propertyguru.R;
import com.example.propertyguru.SelectCityActivity;
import com.example.propertyguru.ShareFeedbackActivity;
import com.example.propertyguru.TermsOfUseActivity;
import com.example.propertyguru.ViewResponseActivity;

public class OwnerDashboardFragment extends Fragment {

    // Define layout references
    private View cardPostProperty, cardSearchProperties;
    private View itemViewResponses, itemEditListings, itemHomepage;
    private View itemShareFeedback;
    private View itemTermsOfUse;
    private View itemCustomerService;

    private View itemRateApp;
    private View itemManageProfile;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (cardPostProperty != null) {
            cardPostProperty.setOnClickListener(v ->
                    startActivity(new Intent(getActivity(), PostPropertyActivity.class)));
        }

        if (cardSearchProperties != null) {
            cardSearchProperties.setOnClickListener(v ->
                    startActivity(new Intent(getActivity(), SelectCityActivity.class)));
        }

        if (itemViewResponses != null) {
            itemViewResponses.setOnClickListener(v ->
                    startActivity(new Intent(getActivity(), ViewResponseActivity.class)));
        }

        if (itemEditListings != null) {
            itemEditListings.setOnClickListener(v ->
                    startActivity(new Intent(getActivity(), EditListingActivity.class)));
        }
